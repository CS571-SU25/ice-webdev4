...
export default function LoginOrCreatePost(props) {
    ...
    function handleLoginSubmit(e) {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su25/ice/login", {
            method: "POST",
            credentials: "include",
            headers: {
    ...
    function handleCommentSubmit(e) {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su25/ice/comments", {
            method: "POST",
            credentials: "include",
            headers: {
                "X-CS571-ID": CS571.getBadgerId(),
    ...
    function handleLogout() {
        fetch("https://cs571api.cs.wisc.edu/rest/su25/ice/logout", {
            method: "POST",
            credentials: "include",
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
